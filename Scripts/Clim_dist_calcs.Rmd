...
#average 
sub_dist_avg %>% 
  ggplot(aes(x=fct_reorder(parent.pop, cwd_dist_AVG), y=cwd_dist_AVG, group=parent.pop, fill=elev_m)) +
  geom_col(width = 0.7,position = position_dodge(0.75)) +
  scale_y_continuous(expand = c(0, 0)) +
  scale_fill_gradient(low = "#F5A540", high = "#0043F0") +
  labs(y="CWD Distance \n from WL2", fill="Elevation (m)", x="Population") +
...
sub_dist_avg %>% 
  ggplot(aes(x=fct_reorder(parent.pop, pck_dist_AVG), y=pck_dist_AVG, group=parent.pop, fill=elev_m)) +
  geom_col(width = 0.7,position = position_dodge(0.75)) +
  scale_y_continuous(expand = c(0, 0)) +
  scale_fill_gradient(low = "#F5A540", high = "#0043F0") +
  labs(y="PCK Distance \n from WL2", fill="Elevation (m)", x="Population") +
...
sub_dist_avg %>% 
  ggplot(aes(x=fct_reorder(parent.pop, ann_tmean_dist_AVG), y=ann_tmean_dist_AVG, group=parent.pop, fill=elev_m)) +
  geom_col(width = 0.7,position = position_dodge(0.75)) +
  scale_y_continuous(expand = c(0, 0)) +
  scale_fill_gradient(low = "#F5A540", high = "#0043F0") +
  labs(y="Temp Distance \n from WL2", fill="Elevation (m)", x="Population") +
...
sub_dist_avg %>% 
  ggplot(aes(x=fct_reorder(parent.pop, ann_ppt_dist_AVG), y=ann_ppt_dist_AVG, group=parent.pop, fill=elev_m)) +
  geom_col(width = 0.7,position = position_dodge(0.75)) +
  scale_y_continuous(expand = c(0, 0)) +
  scale_fill_gradient(low = "#F5A540", high = "#0043F0") +
  labs(y="PPT Distance \n from WL2", fill="Elevation (m)", x="Population") +
