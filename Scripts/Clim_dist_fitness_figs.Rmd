...
# Code for figures relating climate distance to fitness (Figure 4-5; S4-S8)
...
figs4_sub <- ggarrange(WYtemp_est, WYtemp_y1surv, 
                        WYppt_est, 
                        labels = c("A)", "B)", "C)"), 
                        font.label = list(size=30, face = "plain"), 
                        ncol=2, nrow=2) 
...
## Figure S5: Growth Season Clim Dist - Temp and PPT
```{r}
...
figs5_sub <- ggarrange(est_temp, NULL,
                         totrep_temp, totrep_ppt,
                        labels = c("A)", "", "B)"), 
                        font.label = list(size=30, face = "plain"), 
                        ncol=2, nrow=2) 
ggsave("../Figures/FigureS5_GrwSsn.png", width = 26, height = 18, units = "in")
```
...
## Figure S7: Gower's growth season climate distance effects
```{r}
...
figs7_gower <- ggarrange(est_gowers, y1_surv_gowers, 
                        repsurvy2_gowers, totrep_gowers,
                        labels = c("A)", "B)", "C)", "D)"), 
                        font.label = list(size=30, face = "plain"), 
                        ncol=2, nrow=2) 
ggsave("../Figures/FigureS7_GRWSSNGowers.png", width = 26, height = 18, units = "in")
```


## Figure S8: Geographic Distance
```{r}
est_geo <- est_summary %>% 
...
figS8_geo <- ggarrange(probfit_geo, est_geo, repsurvy2_geo, 
                        labels = c("A)", "B)", "C)"), 
                        font.label = list(size=30, face = "plain"), 
                        ncol=2, nrow=2) 
ggsave("../Figures/FigureS8_Geo.png", width = 26, height = 18, units = "in")
```