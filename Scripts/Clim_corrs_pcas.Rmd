...
cor.norm_all_clim
cor.sig_all_clim$p
#tmn, tmx, tmean_wettest_month, tmean_driest_month and ann_tmean all highly correlated (92-99%) - only keep ann_tmean 
...
all_clim_avgs_locs.pc = cbind(all_clim_avgs, all_clim_avgs.pc.dat) %>% 
  select(parent.pop, elev_m, timeframe, Season, PC1:PC13)
