...
-   Move the axis loadings labels to the outside of the axes using annotation_custom() for the climate change PCA (+ rotate the y axis labels)

-   Make the lines purple instead of black on the climate change PCA
...
```{r}
#define annotations to axis labels 
text_x_low = textGrob("Cold/Snow", gp=gpar(fontsize = 14,col="gray35"))
text_x_high = textGrob("Warm/No Snow", gp=gpar(fontsize = 14,col="gray35"))
text_y_low = textGrob("Dry \n Low Temp Range", gp=gpar(fontsize = 14,col="gray35"), rot=90)
text_y_high = textGrob("Wet \n High Temp Range", gp=gpar(fontsize = 14,col="gray35"), rot=90)
...
home_sites_pca_allclim <- all_clim_avgs_locs.pc %>%  
  ...
  annotation_custom(text_x_high, xmin= 3, xmax=3.5,ymin=-6.4,ymax=-6.4) + 
  annotation_custom(text_x_low, xmin= -5.8, xmax=-5,ymin=-6.4,ymax=-6.4) +
  annotation_custom(text_y_high, xmin= -8, xmax=-8,ymin=5.7,ymax=6.8) +
  annotation_custom(text_y_low, xmin= -8, xmax=-8,ymin=-5.7,ymax=-2) +
