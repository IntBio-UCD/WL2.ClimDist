...
To do: give predictions a data frame from one row per combination of factors that are relevant (fixed effects; expand_grid)
...
prob_fitness_sub_preds_check <- tibble(.pred=predict(WY_Recent_sub_mod, newdata=pred_df_cuml, 
                                               re.form= NA, type="response")) %>% 
  bind_cols(pred_df_cuml) %>% 
